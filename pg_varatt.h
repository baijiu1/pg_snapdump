...
#ifndef PG_HEXRETRO_PG_VARATT_H
#define PG_HEXRETRO_PG_VARATT_H
#include "pg_c.h"
...
typedef union
{
    ...
    {
        uint32		va_header;
        uint32		va_rawsize;	/* Original data size (excludes header) and
...
#define VARTOASTRELID(PTR) (((varatt_external*) (((varattrib_1b_e *) (PTR))->va_data))->va_toastrelid)
...
struct ScanContext;
char *text_to_cstring(ScanContext *ctx, const text *);

#define CStringGetTextDatum(s) PointerGetDatum(cstring_to_text(s))
#define TextDatumGetCString(ctx, d) text_to_cstring(ctx, (text *) DatumGetPointer(d))
...
#define VARDATA_COMPRESSED_GET_EXTSIZE(PTR) \
	(((varattrib_4b *) (PTR))->va_compressed.va_rawsize & VARLENA_EXTSIZE_MASK)
#define VARDATA_COMPRESSED_GET_COMPRESS_METHOD(PTR) \
	(((varattrib_4b *) (PTR))->va_compressed.va_rawsize >> VARLENA_EXTSIZE_BITS)

/* Same for external Datums; but note argument is a struct varatt_external */
#define VARATT_EXTERNAL_GET_EXTSIZE(toast_pointer) \
	((toast_pointer).va_extinfo & VARLENA_EXTSIZE_MASK)
#define VARATT_EXTERNAL_GET_RAWSIZE(toast_pointer) \
	((toast_pointer).va_rawsize)
#define VARATT_EXTERNAL_GET_VALUEID(toast_pointer) \
	((toast_pointer).va_valueid)
#define VARATT_EXTERNAL_GET_COMPRESS_METHOD(toast_pointer) \
	((toast_pointer).va_extinfo >> VARLENA_EXTSIZE_BITS)
#define VARATT_EXTERNAL_GET_RELID(toast_pointer) \
